...
function AddDescriptionPage() {
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$civic$2d$cops$2d$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])("/users/issues/with-files", {
                method: "POST",
                body: form
            });
            ...
            setError((e === null || e === void 0 ? void 0 : e.message) || "Failed to submit complaint");
        } finally{
            setSubmitting(false);
        }
    };
...
//# sourceMappingURL=civic-cops-frontend_76e2aae4._.js.map